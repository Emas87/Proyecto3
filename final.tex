...
\hline 
St & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{red} \\ \hline 
T1 & \cellcolor{blue} & & \cellcolor{blue} & \\ \hline 
T2 & & \cellcolor{purple} & & \cellcolor{purple} \\ \hline 
\end{tabular} 
\caption{ Rate Monotonic 1 } 
\end{table} 
Escala Bloque : Ciclos = 1 : 1 \\Posicion Fallo:  3 \\mcm:  6 \\\end{frame} 
\begin{frame} 
...
\end{table} 
Escala Bloque : Ciclos = 1 : 1 \\Posicion Fallo:  0 \\mcm:  6 \\\end{frame} 
\begin{frame} 
