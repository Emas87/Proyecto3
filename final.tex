...
\end{table} 
Escala Bloque : Ciclos = 1 : 1 \\Posicion Fallo:  5 \\mcm:  60 \\\end{frame} 
\begin{frame} 
...
T2 & & & & \cellcolor{red} & \cellcolor{red} & & & & & \cellcolor{red} & \cellcolor{red} \\ \hline 
T3 & & \cellcolor{green} & \cellcolor{green} & & & & \cellcolor{green} & \cellcolor{green} & & & \\ \hline 
\end{tabular} 
\caption{ Earliest Dead First 1 } 
\end{table} 
Escala Bloque : Ciclos = 1 : 1 \\Posicion Fallo:  10 \\mcm:  60 \\\end{frame} 
\begin{frame} 
...
\end{table} 
Escala Bloque : Ciclos = 1 : 1 \\Posicion Fallo:  9 \\mcm:  60 \\\end{frame} 
