...
T2 & & \cellcolor{purple} & \cellcolor{purple} & & & & & & & \cellcolor{purple} & & \cellcolor{purple} & & & & & & & \cellcolor{purple} & \cellcolor{purple} & & & & \\ \hline 
\end{tabular} 
...
\hline 
St & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} \\ \hline 
...
%\hline
%\cellcolor{blue!25}1 & \cellcolor{FFFFFF}2 & 3 & 4 & 5 \\ \hline
%\cellcolor{FE0000}  & \cellcolor{FFFFFF}  & & & \\ \hline
% & \cellcolor{3166FF}  & \cellcolor{3166FF} & & \\ \hline
% & & & \cellcolor{red!25}z & \cellcolor{grey} \\ \hline
%\end{tabular}
%\end{table}
%\end{frame}
